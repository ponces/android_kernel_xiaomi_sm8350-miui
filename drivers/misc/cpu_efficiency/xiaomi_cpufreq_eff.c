...
static int cluster0_effiency[MAX_CLUSTER_PARAMETERS] = { 806400, 50000, 1305600,
							 80000, 0 };
...
static int cluster1_effiency[MAX_CLUSTER_PARAMETERS] = { 844800, 60000, 1324800,
							 100000, 0 };
...
static int cluster2_effiency[MAX_CLUSTER_PARAMETERS] = { 960000, 80000, 1555200,
							 120000, 0 };
...
static unsigned int sm8350_pd_sliver[16] = { 0, 0, 0, 0, 0, 1, 1, 2,
					     2, 2, 3, 3, 3, 4, 5, 5 };
static unsigned int sm8350_pd_golden[16] = { 0, 1, 1, 2, 2, 3, 3, 4,
					     4, 4, 5, 6, 6, 7, 7, 8 };
static unsigned int sm8350_pd_goplus[19] = { 0, 1, 1, 1, 2, 2, 3, 3, 4, 4,
					     4, 5, 6, 7, 7, 7, 7, 8, 8 };
				 ...
				 unsigned int freq)
{
	...
	index = cpufreq_frequency_table_target(policy, freq,
					       CPUFREQ_RELATION_L);
...
MODULE_DESCRIPTION("Xiaomi CPUFreq Efficiency");
MODULE_VERSION("1.0");
